...
function recupFichier()
{
	...
	$time_between = array('2013-01-01-2013-02-01');
	
	foreach($time_between as $between)
	{
		...
		foreach ($property_classes as $class) {
		        ...
		        if($class == "1")
		        	...
		        	$name = 'vacant_land';
		        $file_name = strtolower("data/property_".$name."_".$between.".csv");
...
function recupDonnees()
{
	...
	$all_fichier = array('property_residential_2013-01-01-2013-02-01');
