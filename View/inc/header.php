...
<!-- Main CSS -->
<link href="http://localhost/yesorlandofl/Assets/css/style.css" rel="stylesheet">

<script src="http://localhost/yesorlandofl/Assets/js/vendor/modernizr-2.6.2.min.js"></script>
<!--[if lt IE 9]>
    <script src="http://localhost/yesorlandofl/Assets/js/vendor/respond.min.js"></script>
<![endif]-->
  ...
  <div class="container">
    <div class="navbar-header">
      ...
      <hgroup class="margin-zero navbar-brand">
        ...
        <h6 class="margin-zero lh-80">
          <a class="color-sec  sans  size-14" rel="tab"  href="">International real Estate Experts </a>
        </h6>
      </hgroup>
    </div><!-- navhead -->
    ...
    <div class="nav-collapse collapse navbar-ex1-collapse">
      <ul class="nav navbar-nav fr-lg">
        <li><a rel="tab" href="/" title="home"><i class="icon-home"></i></a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a rel="tab" href="commercial.php">commercial</a></li>
            <li><a rel="tab" href="<?php echo $burl.$l_central_fl ?>">central florida</a></li>
          </ul>
        </li>
        <li><a rel="tab" href="brand.php">Sell/Lease</a></li>
        <li><a rel="tab" href="relocation">Relocation</a></li>
        <li><a rel="tab" href="blog.php">Blog</a></li>

        <li><a rel="tab" href="careers">Careers</a></li>
        <li><a rel="tab" href="contact">Contact</a></li>

        <li class="dropdown">
          <a href="" class="dropdown-toggle" data-toggle="dropdown">My Portfolio <b class="caret"></b></a>
          <ul class="dropdown-menu">
            <li><a href="residential.php">Sing in / up</a></li>
            <li><a href="commercial.php">Mange portfolio</a></li>
